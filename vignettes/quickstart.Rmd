...
need an additional for loops, impacting readability and making code maintenance
more of a hassle. `reval` takes care of that stuff for you. We replace the
...
Check out the `eval_many` function documentation for more 
examples.
